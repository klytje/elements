...
namespace cycfi { namespace elements
{
   void draw_button_base(
      context const& ctx, rect bounds, color color_, bool enabled, std::array<float, 4> corner_radius)
   {
   ...
   void default_button_styler::draw(context const& ctx)
   {
      ...
      draw_button_base(ctx, bounds, body_color, enabled, {get_corner_radius_top_right()*rel_size, get_corner_radius_top_left()*rel_size, get_corner_radius_bottom_left()*rel_size, get_corner_radius_bottom_right()*rel_size});
